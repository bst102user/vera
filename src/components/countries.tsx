...
const Countries = () => {
  const countries = [
    "Germany", "France", "Italy", "Spain", "Netherlands", "Belgium", "Austria", "Switzerland", "Poland",
    "Czech Republic", "Hungary", "Portugal", "Sweden", "Denmark", "Norway", "Finland",
  ];
    ...
    <section className="relative bg-gray py-20">
      ...
      <div className="relative z-10 text-center max-w-4xl mx-auto px-4">
        <h2 className="text-2xl md:text-3xl font-semibold mb-6">
          Active in <span className="text-[#C61AFF]">16+ European Countries</span>
        </h2>
