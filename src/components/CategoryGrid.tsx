...
const categories = [
    {
        ...
        bg: "bg-[#eef1f4]",
        span: "col-start-1 col-end-12 row-start-1 row-end-3 md:col-start-1 md:col-end-5 md:row-start-1 md:row-end-5",
    },
    {
        ...
        bg: "bg-[#eef1f4]",
        span: "col-start-1 col-end-12 row-start-3 row-end-5 md:col-start-5 md:col-end-9 md:row-start-1 md:row-end-3",
    },
    {
        ...
        image: "/assets/tv.png",
        bg: "bg-[#eef1f4]",
        span: "col-start-1 col-end-12 row-start-5 row-end-7 md:col-start-5 md:col-end-7 md:row-start-3 md:row-end-5",
    },
    {
        ...
        bg: "bg-[#eef1f4]",
        span: "col-start-1 col-end-12 row-start-7 row-end-9 md:col-start-7 md:col-end-9 md:row-start-3 md:row-end-5",
    ...
    },
    {
        ...
        bg: "bg-[#84A8A9]",
        text: "text-white",
        span: "col-start-1 col-end-12 row-start-9 row-end-12 md:col-start-9 md:col-end-13 md:row-start-1 md:row-end-5",
    },
];
