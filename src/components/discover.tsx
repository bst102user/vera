        ...
        <div>
            <section className="max-w-[1300px] mx-auto px-4 py-8 md:py-16">
                <div className="grid grid-cols-1 md:grid-cols-[1fr_2fr_1fr] gap-6">
                    ...
                    {/* Box 2 */}
                    <div className="bg-white rounded-lg overflow-hidden flex items-center shadow-sm bg-right bg-cover"
                        style={{
                    ...
                    <div className="bg-orange-400 rounded-lg overflow-hidden shadow-sm">
                        <img src="/assets/discover3.jpg" alt="Success Image" className="w-full h-[300px] object-cover" />
                    </div>
                </div>
            </section>
